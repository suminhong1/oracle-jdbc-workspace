/*
    ...
    * 삭제
    DROP FUNCTION 함수명;
*/
-- 사번(V_EMP_ID)을 입력받아 해당 사원의 보너스(V_BONUS)를 포함하는 연봉을 계산하고 리턴(데이터 타입 : NUMBER)하는 함수 생성
-- 함수명 : BONUS_CALC ,급여 : V_SALARY, 보너스 : V_BONUS
...
-- EMPLOYEE 테이블에서 방금 만든 함수 (BONUS_CALC)를 이용해서 보너스를 포함한 연봉이 4000만원 이상인 사원의 사번, 직원명, 급여, 보너스, 보너스를 포함한 연봉조회
